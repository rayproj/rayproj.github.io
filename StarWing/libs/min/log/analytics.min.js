(function () {
    ...
    var w = /:[0-9]+$/,
        ...
        z = function (a) { //cjh format url and return location object
            console.log('cjh format url: ' + a);
    ...
    var Q = function (a, b, c) {
        ...
        P = function (a) {
            ...
            try {
                ...
                console.error('cjh error: ' + t + ", stack: " + t.stack);
            }
        };
    ...
    var X = function (a) {
            try {
                ...
                console.error('cjh error: ' + e + ", stack: " + e.stack);
            }
        },
        Y = function (a) {
            try {
                ...
                console.error('cjh error: ' + d + ", stack: " + d.stack);
            }
        };
...
(function () {
    ...
    var F = window,
        ...
        G = function (a) {
            ...
            let ret = Ea.getElementById("__gaOptOutExtension") ?
                !0 : !1;
            //console.log(`cjh Ea.getElementById("__gaOptOutExtension") return : ${ret}`);
            return ret;
        };
    var Ca = function (a) {
            var b = [],
    ...
    var Fa, Ga, fb, Ab, ja = /^https?:\/\/[^/]*cdn\.ampproject\.org\//,
        ...
        Pc = function (a, b, c) {
            ...
            //console.log('cjh xhr open: ' + (c || "https://ampcid.google.com/v1/publisher:getClientId") + "?key=AIzaSyA65lEHUEizIsNtlbNo-l2K18dT680nsaM");
            ...
            a && (d.securityToken = a);
            console.log('cjh xhr post send: ' + JSON.stringify(d));
        ...
        Qc = function (a, b, c) { //cjh cleanup method
            Ga && clearTimeout(Ga);
            b && xc(b, c);
            Ab = a;
            b = Ub;
    ...
    var ad = void 0,
        ...
        function (a, b, c, d) {
            ...
            console.log('cjh xhr post open: ' + a);
            g.open("POST", a, !0);
            g.withCredentials = !0;
            g.setRequestHeader("Content-Type", "text/plain");
            g.onreadystatechange = function () {
                //console.log('cjh readyState: ' + g.readyState);
                if (4 == g.readyState) {
                    //console.log('cjh xhr responseText: ' + g.responseText);
                    if (d) try {
    ...
    function Sa(a) { //cjh collect data and send to ga, use HTMLImageElement or XMLHttpRequest
        ...
        gc = function (a) {
            ...
            if (Ec(b) || Fc(b)) {
                ...
                void 0 == c || Infinity == c || isNaN(c) || (0 < c ? (Y(b, Gb), Y(b, Jb), Y(b, Ib), Y(b, Fb), Y(b, Hb), Y(b, Kb), Y(b, Lb), Y(b, Ve), Y(b, We), Y(b, Xe), Y(b, Ye), va(function () {
                    console.log('cjh callback 1');
                    a(b)
                }, 10)) : L(O, "load", function () {
                    console.log('cjh window load event ...');
                    gc(a)
                }, !1))
            }
            else {
                console.log('cjh gc 222 ...');
            }
        },
        Ec = function (a) {
    ...
    Z.v = function (a) {
        try {
            ...
            console.error('cjh error: ' + g + ', stack: ' + g.stack);
        }
    };
    var N = function (a) {
        //console.log('cjh send 01');
        J(1);
